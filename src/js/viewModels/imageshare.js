		 ...
		 console.log('here-0');
          document.addEventListener('deviceready', function () {
              var HandleIntent = function (Intent) {
                  ...
                  console.log(Intent.extras["android.intent.extra.STREAM"]); 
               ...
               Intent.extras["android.intent.extra.STREAM"],
                function (realPath) {
					...
					var ref = cordova.InAppBrowser.open(realPath, '_blank', 'location=yes');
              ...
              window.plugins.intent.setNewIntentHandler(HandleIntent);
                console.log(HandleIntent.EXTRA_STREAM);
