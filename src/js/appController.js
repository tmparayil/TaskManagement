  ...
  function(oj, ko) {
    function ControllerViewModel() {
      ...
      self.router.configure({
       ...
       'imageshare': {label: 'Imageshare'},
       
	   'contacts1': {label: 'Contacts'},
	   'viewcalendar': {label: 'Viewcalendar'},
	   'createtask': {label: 'Createtask'}
      });
      ...
      {name: 'Imageshare', id: 'imageshare',
        iconClass: 'oj-navigationlist-item-icon demo-icon-font-24 demo-fire-icon-24'},
      
      
     
		{name: 'Contacts', id: 'contacts1',
        iconClass: 'oj-navigationlist-item-icon demo-icon-font-24 demo-people-icon-24'},
		{name: 'Viewcalendar', id: 'viewcalendar',
        iconClass: 'oj-navigationlist-item-icon demo-icon-font-24 demo-person-icon-24'},
		{name: 'Createtask', id: 'createtask',
